...
data:extend({

	{
		...
		icon = "__fusion_machines__/graphics/nuclear-assembling-machine.png",
		subgroup = "production-machine",
		color_hint = { text = "2" },
		order = "d[nzfusion-assembling-machine]",
		inventory_move_sound = item_sounds.mechanical_inventory_move,
		pick_sound = item_sounds.mechanical_inventory_pickup,
		drop_sound = item_sounds.mechanical_inventory_move,
		default_import_location = "aquilo",
		weight = 200 * kg,
		place_result = "fusion-assembling-machine",
		stack_size = 10,
	},
	{
		type = "recipe",
...

	{
		...
		minable = { mining_time = 0.2, result = "fusion-assembling-machine" },
		max_health = 350,
		...
		graphics_set = {
			animation = {
				layers = {
					{
						filename = "__fusion_machines__/graphics/nuclear-assembling-machine/nuclear-assembling-machine.png",
						priority = "high",
						width = 214,
						height = 218,
						frame_count = 32,
					...
					{
						filename = "__fusion_machines__/graphics/nuclear-assembling-machine/nuclear-assembling-machine-light.png",
						width = 214,
						height = 218,
						frame_count = 32,
						line_length = 8,
